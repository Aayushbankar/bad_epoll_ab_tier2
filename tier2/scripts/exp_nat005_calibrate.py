...
# Enable GDB logging
gdb.execute("set logging file /mnt/work/company/cyphermatrix/repos/bad-epoll-lab/tier2/evidence/NAT-005_calibration_raw.log")
...
class RebootTrace(gdb.Breakpoint):
    ...
    def stop(self):
        log("RUNTIME TRACE: __arm64_sys_reboot hit! Calibration measurement complete.")
        gdb.execute("detach")
        gdb.execute("quit")
        return False
...
log("Breakpoints set on ksys_write and __arm64_sys_reboot (NO inner __ep_remove breakpoints). Continuing...")
