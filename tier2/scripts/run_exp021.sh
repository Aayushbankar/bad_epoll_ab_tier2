...
cd "$TIER2_DIR"
./aarch64-linux-musl-cross/bin/aarch64-linux-musl-gcc -static -O0 -g -o rootfs/harness scripts/test_exp021.c -pthread
...
echo "[*] Running EXP-021 GDB script..."
gdb -batch -q -x scripts/exp021_gdb.py android/artifacts/vmlinux
