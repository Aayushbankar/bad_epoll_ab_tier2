...
| HYP-002 | 2026-09-05 | Kernel-Side Debugfs Counter Ground-Truth Test: Add debug counters in `__ep_remove`/`ep_free` to detect if natural race fires silently without oracle detecting it | test_hyp002.c | (none) | run_hyp002.sh | **REJECTED** (0 hits; oracle is correct) | `tier2/evidence/HYP-002/HYP-002_RESULTS.md` |
