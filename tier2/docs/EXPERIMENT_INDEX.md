...
| HYP-002 | 2026-09-05 | Kernel-Side Debugfs Counter Ground-Truth Test: Add debug counters in `__ep_remove`/`ep_free` to detect if natural race fires silently without oracle detecting it | test_hyp002.c | (none) | run_hyp002.sh, run_hyp002_repro.sh | **REJECTED** (0 hits across 6.12.67 and 3x GKI 6.1.23 repro runs: 0/15,000; single hit in cf24bd6 retracted as false positive from uninitialized debug_freed) | `tier2/evidence/HYP-002/HYP-002_RESULTS.md`, `tier2/evidence/HYP-002/HYP-002_RESULTS_GKI.md` |
