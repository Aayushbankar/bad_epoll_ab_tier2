...
| NAT-005 | 2026-08-05 | Adaptive Launch-Ahead Search & Topology Verification | test_nat005.c | exp_nat005_gdb.py | run_nat005.sh | **PASSED** (0/92,740 hits; calibrated 2,330 cycle window; best alignment error=2 cycles) | `tier2/evidence/NAT-005_RESULTS.md` |
