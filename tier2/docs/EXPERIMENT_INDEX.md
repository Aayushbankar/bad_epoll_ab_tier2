...
| NAT-005 | 2026-08-05 | Adaptive Launch-Ahead Search & Topology Verification | test_nat005.c | exp_nat005_gdb.py | run_nat005.sh | **PASSED** (0/100,000 hits; topology verified) | `tier2/evidence/NAT-005_RESULTS.md` |
