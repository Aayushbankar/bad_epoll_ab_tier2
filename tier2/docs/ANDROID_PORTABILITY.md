...
|---|---------------|----------------|------------|-------------------|------------|
| **LF-001** | Race exists (lockless fast-path bypass) | **UNKNOWN** — GDB-assisted only | **BLOCKER** | Natural schedulability unproven | NAT-001, NAT-002 |
...
|---------|----------|------------|-----|
| **Natural race unproven** | CRITICAL | NAT-001/002 | Week 1 |
